...
filmController={
    ...
    //     }
        ...
        const {title, duration, genre, actor, director, producer, filmmaker, rating,ads_url, short_description, long_description, is_slider, status, trailer, stream_file } = req.body;
    ...
    async updatefilm(req, res, next)
    {
        ...
        const {title, duration, genre, actor, director, producer, filmmaker, rating,ads_url, short_description, long_description, is_slider, status, trailer, stream_file,id } = req.body;
    ...
    async getfilmById(req, res, next)
    {
        ...
        try{
            const filmData = await Film.findById({_id: id}).populate('genre').populate('actor')
            .populate('director')
            .populate('producer')
            .populate('filmmaker');
            const film =filmData;
